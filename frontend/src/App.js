...
function App() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center">
      <h1 className="text-3xl font-bold mb-8 p-4 text-center sm:text-left">
        Recomendador de Produtos RD Station
      </h1>
      <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-3/4 min-[1240px]:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="col-span-1 md:col-span-2 w-full flex flex-col md:flex-row justify-center gap-10">
          <div >
